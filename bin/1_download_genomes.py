...
summary_file = downloader.download_summary_file('ftp.ncbi.nlm.nih.gov', '/genomes/ASSEMBLY_REPORTS/assembly_summary_refseq.txt', args.outdir + '/')
downloader.download_files(summary_file, args.species_list, args.outdir + '/genome.tsv', args.outdir + '/genome.err', args.debug)
